...
function Home(props) {
    ...
    return (
        <Layout item={props.item}>
            <header>
                <span class="spa"><a href={`/items?token=${props.token}`}><button title="My Listings">📦</button></a></span>
                <span class="spa"><h1>Home Page</h1></span>
                <span class="spa"><a href={`/items/cart?token=${props.token}`}><button title="View Cart">🛒</button></a></span>
            </header>
